...
def run_test_practice_problem2a():
    ...
    print('Test 1: predicted: [4, 5, 4, 5, 4]')
    print('        actual:   ', practice_problem2a([1, 2, 1, 2, 1], 3))

    print('Test 2: predicted: [0, 5, 10]')
    print('        actual:   ', practice_problem2a([-5, 0, 5], 5))

    print('Test 3: predicted: [-1, -1, -2]')
    print('        actual:   ', practice_problem2a([-1, -1, -2], 0))

    print('Test 4: predicted: [-4, -2, -1]')
    print('        actual:   ', practice_problem2a([-2, 0, 1], -2))
...
def practice_problem2b(sequence):
    ...
    for k in range(len(sequence)):
        item = sequence[k]
        if len(item) > 0:
            new_sequence = new_sequence + str(item[0])
    return new_sequence
